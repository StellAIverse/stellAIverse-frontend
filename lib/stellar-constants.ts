...
export const STELLAR_NETWORKS: Record<string, StellarNetworkConfig> = {
  mainnet: {
    name: 'mainnet',
    displayName: 'Mainnet',
    horizonUrl: process.env.NEXT_PUBLIC_STELLAR_MAINNET_URL || 'https://horizon.stellar.org',
    networkPassphrase: process.env.NEXT_PUBLIC_STELLAR_NETWORK_PASSPHRASE_MAINNET || 'Public Global Stellar Network ; September 2015',
    color: 'bg-blue-600',
    badge: '🟦 Mainnet',
  },
  testnet: {
    name: 'testnet',
    displayName: 'Testnet',
    horizonUrl: process.env.NEXT_PUBLIC_STELLAR_TESTNET_URL || 'https://horizon-testnet.stellar.org',
    networkPassphrase: process.env.NEXT_PUBLIC_STELLAR_NETWORK_PASSPHRASE_TESTNET || 'Test SDF Network ; September 2015',
    color: 'bg-yellow-500',
    badge: '🟨 Testnet',
  },
  futurenet: {
    ...
    horizonUrl: process.env.NEXT_PUBLIC_STELLAR_FUTURENET_URL || 'https://horizon-futurenet.stellar.org',
    networkPassphrase: process.env.NEXT_PUBLIC_STELLAR_NETWORK_PASSPHRASE_FUTURENET || 'Test SDF Future Network ; October 2022',
    color: 'bg-purple-600',
    badge: '🟪 Futurenet',
  },
};
...
const defaultNetworkValue = (process.env.NEXT_PUBLIC_DEFAULT_STELLAR_NETWORK || 'mainnet') as string;
